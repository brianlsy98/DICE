...
def main(args):
    ...
    model_path = (
        ...
        f"{model_params['gnn_type']}_depth{args.gnn_depth}_simsiam.pt"
    )
    ...
    # Run t-SNE
    print(f"\nGraph embeddings t-SNE (SimSiam)...")
    start = time.time()
    ...
    plot_path = f"./pretrain/encoder/plot/trained_gnn_embeddings/tsne_trained_{model_params['gnn_type']}_depth{args.gnn_depth}_simsiam_gf.png"
    plt.tight_layout()
