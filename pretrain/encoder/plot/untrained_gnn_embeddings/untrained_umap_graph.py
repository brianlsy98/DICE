...
def main(args):
    ...
    for batch in tqdm(dataloader, desc='Processing Batches'):
        ...
        _, _, gf = untrained_encoder(umap_batch)
    ...
    print("\nGraph embeddings UMAP (untrained)...")
    start = time.time()
    ...
    plot_path = f"./pretrain/encoder/plot/untrained_gnn_embeddings/umap_untrained_{model_params['gnn_type']}_depth{args.gnn_depth}_gf.png"
    plt.tight_layout()
